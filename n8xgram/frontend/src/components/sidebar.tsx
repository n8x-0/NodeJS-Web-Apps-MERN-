...
import { sessionCont } from '@/context/session';import Link from 'next/link';
;
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: PlusSquare, label: 'Create', route: `/profile/${session.userSession._id}/post`},
    { icon: User, label: 'Profile', route: `/profile/${session.userSession._id}`}
  ];
